...
MP_DEFINE_CONST_OBJ_TYPE(
	face_detection_type,
	MP_QSTR_face_detection,
	MP_TYPE_FLAG_NONE,
	make_new, face_detection_make_new,
	locals_dict, &face_detection_locals_dict);
//-----------------------------------------------------------------------------------
#if MICROPY_ENABLE_CAT_DETECTION
...
MP_DEFINE_CONST_OBJ_TYPE(
	cat_detection_type,
	MP_QSTR_cat_detection,
	MP_TYPE_FLAG_NONE,
	make_new, face_detection_make_new,
	locals_dict, &cat_detection_locals_dict);
#endif
//====================================================================================
#if MICROPY_ENABLE_MOTION_DETECTION
...
MP_DEFINE_CONST_OBJ_TYPE(
	...
	MP_QSTR_motion_detection,
	MP_TYPE_FLAG_NONE,
	make_new, motion_detection_make_new,
	locals_dict, &motion_detection_locals_dict);
#endif
