...
static bool ll_cam_calc_rgb_dma(cam_obj_t *cam){
    ...
    ESP_LOGI(TAG, "node_size: %4ld, nodes_per_line: %u, lines_per_node: %u", 
    ...
    ESP_LOGI(TAG, "dma_half_buffer_min: %5ld, dma_half_buffer: %5ld, lines_per_half_buffer: %2u, dma_buffer_size: %5ld", 
